...
class Machine:
    ...
    def get_game_first_card(self):
        ...
        # if the game's started with a changecolor card, the next user should verify the compatibility with the user_choice due to another method in this same class
        if isinstance(self.CURRENTLY_CARD, WildCard):
